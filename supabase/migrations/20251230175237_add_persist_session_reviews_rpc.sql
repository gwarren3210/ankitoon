-- Migration to add RPC function for transaction-based persistence of session reviews
-- Wraps card updates and log inserts in a single transaction for atomicity
...
BEGIN
  ...
  LOOP
    ...
    VALUES (
      ...
      (v_card_update->>'next_review_date')::TIMESTAMP WITH TIME ZONE,
      CASE 
