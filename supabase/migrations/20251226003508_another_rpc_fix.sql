-- Add scheduled_days and learning_steps to get_study_cards RPC function
-- These fields are needed by the client to properly construct FSRS Card objects
...
RETURNS TABLE (
  ...
  example TEXT,
  sense_key TEXT,
  vocabulary_created_at TIMESTAMP,
  srs_card_id UUID,
  state srs_state,
  stability REAL,
  difficulty REAL,
